...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By *Thakudu*' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '*Thakudu Bot*' : process.env.BOT_NAME,
